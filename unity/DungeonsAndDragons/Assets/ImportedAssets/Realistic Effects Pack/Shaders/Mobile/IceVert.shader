...
#pragma surface surf BlinnPhong alpha vertex:vert noforwardadd approxview halfasview 
#pragma target 3.0
#pragma glsl
...
void surf (Input IN, inout SurfaceOutput o) {
		...
		if(_RefractiveStrength > 0.001)
		{
			...
			offset = refractedDir.xy + o.Normal.rg * _BumpAmt * _GrabTextureMobile_TexelSize.xy;
		}
		else offset = o.Normal.rg * _BumpAmt * _GrabTextureMobile_TexelSize.xy;
		...
		o.Emission = col.xyz * _Color + tex.r * _MainTexAlpha + (fresnel *_ReflectColor) * _Cutoff + col.xyz * (fresnelRim * _RimColor)* _Cutoff;
        o.Alpha = _Color.a;
}
ENDCG
}
